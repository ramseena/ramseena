...
const BankBook =({route,navigation}) =>{
  ...
  let deviceId = await DeviceInfo.getUniqueId()
    ...
    const listDetails= await getDetails(clienttoken,token,"Bank Book",deviceId,route.params.value,toggled)
  ...
  return (
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f1f2f4',justifyContent:"center",alignContent:"center" ,marginTop:StatusBar.currentHeight}}>
      ...
      />
           ...
           <TouchableOpacity style={styles.boxView} onPress={() => navigation.navigate("BankBookDetail", { data: todayData.details, date: todayData.date, totcredit: todayData.total_credit, totdebit: todayData.total_debit, name: todayData.name ,code:route.params.value})}>
         ...
         <TouchableOpacity style={styles.boxView} onPress={() => navigation.navigate("BankBookDetail", { data: yesterdayData.details, date: yesterdayData.date, totcredit: yesterdayData.total_credit, totdebit: yesterdayData.total_debit, name: yesterdayData.name ,code:route.params.value})} >
