...
setData(route.params.data.debit)
  ...
  return (
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f1f2f4', marginTop: StatusBar.currentHeight }}>
      ...
      <View style={{ flexDirection: "row" }} >
        <TouchableOpacity style={{width:60}}onPress={() => navigation.navigate("BankBook",{value:route.params.code,itemName:route.params.itemName})}>
          <Image source={require('./../../images/back_round.png')} style={{ width: 38, height: 38 ,resizeMode:"contain"}}></Image>
        </TouchableOpacity>
        <View style={{justifyContent:'center',alignItems:"center"}}><Text style={{textAlign:"center",marginLeft:20, color: "#000", fontSize: 15, fontWeight: "500" }}>{"Bank Book Details"}</Text></View>
      </View>
       ...
       <View style={{flexDirection:"row",alignItems:"flex-start",justifyContent:"flex-start"}}>
         ...
         <View style={[styles.headerText,{padding:2}]}>
